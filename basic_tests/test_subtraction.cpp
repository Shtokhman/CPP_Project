...
TEST(AddTest, sameResult) {
    ...
    matrix res1(3, 3);
    res1 = matrix::sub_parallel(ex1_1, ex1_2);
    ...
    matrix res2(3, 2);
    res2 = matrix::sub_parallel(ex2_1, ex2_2);
    ...
    matrix res3(3, 2);
    res3 = matrix::sub_parallel(ex3_1, ex3_2);

    EXPECT_EQ("{{ -3, 0, 2}, { 0, -3, 6},{ 1, 1, 1}}", res1.to_string_for_test());     // square
    EXPECT_EQ("{{ -3, 0}, { 0, -3}, { 1, 1}}", res2.to_string_for_test());             // rect
    EXPECT_EQ("{{ 3, 0, -6}, { 0, 3, -7}}", res3.to_string_for_test());                // inv rect
}
